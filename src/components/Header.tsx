        ...
        <nav className="hidden lg:flex items-center gap-1">
          {navLinks.map((link) => (
            <button
              ...
              className="text-sm text-muted-foreground hover:text-foreground transition-colors px-3 py-2 rounded-full hover:bg-secondary"
            >
              {link.label}
            </button>
          ))}
            ...
            <nav className="section-container py-6 flex flex-col gap-2">
              {navLinks.map((link, i) => (
                <motion.button
                  ...
                  onClick={() => handleNavClick(link.href)}
                  className="text-left text-base text-muted-foreground hover:text-foreground transition-colors py-2 px-3 rounded-lg hover:bg-secondary"
                >
                  {link.label}
                </motion.button>
              ))}
