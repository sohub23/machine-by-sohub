...
<body>
<div class='header'><h2 style='margin:0'>🔔 New Interest Request - $machineType</h2></div>
<p>Hello Admin,</p>
<p>A new interest request has been submitted for <strong>$machineType</strong>.</p>
<table>
<tr><td class='label'>Name:</td><td><strong>$name</strong></td></tr>
<tr><td class='label'>Company:</td><td>" . ($company ?: 'Not provided') . "</td></tr>
<tr><td class='label'>Phone:</td><td><strong>$phone</strong></td></tr>
<tr><td class='label'>Email:</td><td>" . ($email ?: 'Not provided') . "</td></tr>
<tr><td class='label'>Location:</td><td>" . ($location ?: 'Not provided') . "</td></tr>
<tr><td class='label'>Use Case:</td><td><strong>$useCase</strong></td></tr>
</table>
<p style='color:#666;font-size:12px;margin-top:30px'>Request received at: " . date('d M Y, h:i A') . "</p>
</body>
</html>
";
...
<body>
<div class='header'><h1 style='margin:0'>Thank You for Your Interest! 🎉</h1></div>
<p>Dear <strong>$name</strong>,</p>
<p>Thank you for your interest in <strong>SOHUB $machineType</strong>. We have received your request and are excited to discuss your use case!</p>
<div class='box'>
<p style='margin:0;font-size:16px'><strong>📋 Your Request Details:</strong></p>
<p style='margin:10px 0 0 0;font-size:14px;color:#666'>Use Case: $useCase</p>
</div>
...
<li>📞 We will contact you at <strong>$phone</strong> to discuss details</li>
<li>💡 We'll explore how our solution fits your needs</li>
<li>🚀 If suitable, we can arrange a demo or pilot deployment</li>
</ul>
...
try {
    sendEmail($smtp_host, $smtp_port, $smtp_user, $smtp_pass, $admin_email, "New Interest Request - $machineType from $name", $adminEmailBody, 'SOHUB Admin');
    
    if (!empty($email) && filter_var($email, FILTER_VALIDATE_EMAIL)) {
        sendEmail($smtp_host, $smtp_port, $smtp_user, $smtp_pass, $email, "Your SOHUB Interest Request Confirmation", $customerEmailBody, $name);
    }
