const socialLinks = [
  { label: "YouTube", href: "https://www.youtube.com/@sohub", icon: (
  ...
  { label: "Facebook", href: "https://www.facebook.com/sohub", icon: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
  )},
  { label: "LinkedIn", href: "https://www.linkedin.com/company/sohub", icon: (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-primary-foreground/50">
            <li><a href="#machines" className="hover:text-primary-foreground transition-colors">Machines</a></li>
            <li><a href="#ecosystem" className="hover:text-primary-foreground transition-colors">Ecosystem</a></li>
            <li><a href="#payments" className="hover:text-primary-foreground transition-colors">Payments</a></li>
            <li><a href="#video-showcase" className="hover:text-primary-foreground transition-colors">Video Showcase</a></li>
          </ul>
        </div>
        <div>
          <h4 className="text-sm font-semibold mb-4 text-primary-foreground">Company</h4>
          <ul className="space-y-2.5 text-sm text-primary-foreground/50">
            <li><a href="#use-cases" className="hover:text-primary-foreground transition-colors">Use Cases</a></li>
